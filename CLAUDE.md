...
**M5 — Polish & Publish** *(in progress — M5.1/M5.2/M5.3 complete; M5.4 code complete, docs/Marketplace assets pending)*
...
- **Docs + Marketplace assets** *(not started)*: README with animated GIF walkthrough, CHANGELOG, extension icon, Marketplace description, category tags. Content/design work, not code — deliberately left for a separate pass.
